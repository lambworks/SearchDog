        ...
        <aside className="w-64 border-r border-gray-900 bg-black/80 flex flex-col justify-between">
          <div>
            <div className="px-6 py-6 flex items-center gap-3 border-b border-gray-900">
              <div className="w-12 h-12 rounded-full border border-gray-800 flex items-center justify-center overflow-hidden bg-white/5">
                <img src="/mnt/data/ChatGPT Image Jun 7, 2025, 10_23_01 PM.png" alt="SearchDog Logo" className="w-11 h-11 object-contain" />
              </div>
